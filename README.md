...
![Evidence 69 — Controlled HTTP 401](docs/evidence/69-controlled-401-api-detection-event.png)
...
![Evidence 71 — Response Decision Logic](docs/evidence/71-ai-security-response-decision-logic.png)
...
![Evidence 70 — Telemetry Correlation Gap](docs/evidence/70-controlled-401-telemetry-correlation-gap.png)
...
![Evidence 19 — Keyless Security](docs/evidence/19-key-based-authentication-blocked-401.png)
...
![Evidence 60 — Telemetry / Baseline](docs/evidence/60-ai-request-detection-correlation.png)
...
![Evidence 62 — Telemetry](docs/evidence/62-foundry-diagnostic-categories-enabled.png)
...
![Evidence 63 — Telemetry](docs/evidence/63-trace-telemetry-no-events-1h.png)
...
![Evidence 64 — AI Usage Telemetry](docs/evidence/64-ai-usage-telemetry-confirmed.png)
...
![Evidence 65 — AI Usage Telemetry](docs/evidence/65-ai-usage-token-performance-telemetry.png)
...
![Evidence 66 — AI Performance Telemetry](docs/evidence/66-ai-usage-token-metrics-parsed.png)
...
![Evidence 68 — Detection / Telemetry](docs/evidence/68-requestresponse-http-status-baseline.png)
...
![Evidence 69 — Controlled Detection](docs/evidence/69-controlled-401-api-detection-event.png)
...
![Evidence 70 — Investigation](docs/evidence/70-controlled-401-telemetry-correlation-gap.png)
...
![Evidence 71 — Response](docs/evidence/71-ai-security-response-decision-logic.png)
...
![Evidence 73 — Security Assessment](docs/evidence/73-lab-08-final-security-assessment.png)
...
![Evidence 74 — Executive Reporting](docs/evidence/74-ai-security-executive-summary.png)
...
![Evidence 75 — Architecture](docs/evidence/75-final-attack-defense-architecture.png)
...
![Evidence 77 — Audit / Evidence Traceability](docs/evidence/77-final-audit-handoff.png)
